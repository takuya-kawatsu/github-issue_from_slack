...
gcloud functions deploy issue-bot \
  ...
  --set-env-vars="GITHUB_REPO=owner/repo,GCP_PROJECT_ID=YOUR_PROJECT_ID,GCP_LOCATION=asia-northeast1,GEMINI_MODEL=gemini-2.5-pro,CONTEXT_GCS_BUCKET=YOUR_GCS_BUCKET,CONTEXT_GCS_PATH=llm_context.md"
```
